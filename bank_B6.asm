sprite_return_handle_despawn_B6:
...
CODE_B6800D:
	...
	LDY #!special_sprite_spawn_id_0034	;$B6801B   |
	JSL spawn_special_sprite_index		;$B6801E   |
CODE_B68022:					;	   |
	LDX current_sprite			;$B68022   |
	RTS					;$B68024  /

bank_B6_sprite_main_handler_1:
	TAX					;$B68025  \
	PHK					;$B68026   |
	PLB					;$B68027   |
	JMP (.main_table,x)			;$B68028  /
...
.main_table:
	...
	dw tied_up_dk_spawner_sprite_code	;0014 tied_up_donkey_spawner_main
...
kudgel_sprite_code:
	...
	STZ $06A3				;$B68068   |
	STZ $06A5				;$B6806B   |
	LDA #DATA_B684D4			;$B6806E   | Set Kudgel attack pattern starting address
	STA $00065A				;$B68071   |
...
CODE_B6832A:
	...
	JSL spawn_special_sprite_index		;$B68345   |
	LDY #!special_sprite_spawn_id_0060	;$B68349   |
	JSL spawn_no_gfx_special_sprite_index	;$B6834C   |
	LDY #!special_sprite_spawn_id_0062	;$B68350   |
	JSL spawn_no_gfx_special_sprite_index	;$B68353   |
	LDX $0656				;$B68357   |
...
CODE_B683BC:					;	   |
	...
	LDA #$0014				;$B683C9   |
	STA $00073D				;$B683CC   |
	LDA current_held_sprite			;$B683D0   |
...
CODE_B6843A:
	LDA #$0014				;$B6843A  \
	STA $00073D				;$B6843D   |
	LDX current_held_sprite			;$B68441   |
...
CODE_B68AAB:
	...
	LDX $0753				;$B68AB0   |
	LDY $000A,x				;$B68AB3   |
	JSL spawn_special_sprite_index		;$B68AB6   |
...
CODE_B68D7C:
	...
	STZ $06A3				;$B68D8D   |
	STZ $06A5				;$B68D90   |
	LDY #!special_sprite_spawn_id_00C2	;$B68D93   |
	JSL spawn_special_sprite_index		;$B68D96   |
...
CODE_B68DB3:
	...
	LDA #$0001				;$B68DFA   |
	STA $00070B				;$B68DFD   |
	LDY #!special_sprite_spawn_id_0160	;$B68E01   |
...
CODE_B68E1A:					;	   |
	PHA					;$B68E1A   |
	LDY #!special_sprite_spawn_id_0162	;$B68E1B   |
...
CODE_B68EDB:
	...
	LDA #$0014				;$B68EF1   |
	STA $00073D				;$B68EF4   |
	LDX current_held_sprite			;$B68EF8   |
...
CODE_B68F33:					;	   |
	PLB					;$B68F33   |
	JML [sprite_return_address]		;$B68F34  /
...
CODE_B68F50:
	LDY #!special_sprite_spawn_id_0140	;$B68F50  \
	JSL spawn_special_sprite_index		;$B68F53   |
	LDA alternate_sprite			;$B68F57   |
	STA $00075F				;$B68F59   |
	LDY #!special_sprite_spawn_id_011C	;$B68F5D   |
	JSL spawn_special_sprite_index		;$B68F60   |
	LDY alternate_sprite			;$B68F64   |
	STY $075B				;$B68F66   |
	LDY #!special_sprite_spawn_id_011E	;$B68F69   |
	JSL spawn_special_sprite_index		;$B68F6C   |
...
CODE_B68F9B:
	...
	JSL spawn_special_sprite_address	;$B68FB7   |
...
CODE_B693FB:
	LDA #$0014				;$B693FB  \
	STA $00073D				;$B693FE   |
	LDX current_held_sprite			;$B69402   |
...
CODE_B6948B:
	...
	PLB					;$B6948F   |
CODE_B69490:					;	   |
	JML [sprite_return_address]		;$B69490  /
...
CODE_B69572:
	...
	LDA #$002D				;$B6959B   |
	STA $000729				;$B6959E   |
	LDA active_frame_counter		;$B695A2   |
	BIT #$0001				;$B695A4   |
...
CODE_B697AF:					;	   |
	...
	LDA $000C,x				;$B697B8   |
	STA $0048,y				;$B697BB   |
	LDA #sprite_return_handle_despawn_B6	;$B697BE   |
	STA $0046,y				;$B697C1   |
	LDA $0002,x				;$B697C4   |
	STA $0024,y				;$B697C7   |
	LDA $0006,x				;$B697CA   |
...
CODE_B698CA:					;	   |
	...
	LDA $000C,x				;$B698D3   |
	STA $0048,y				;$B698D6   |
	LDA #sprite_return_handle_despawn_B6	;$B698D9   |
	STA $0046,y				;$B698DC   |
	LDA $0002,x				;$B698DF   |
	STA $0024,y				;$B698E2   |
	LDA $0006,x				;$B698E5   |
...
shot_donkey_kong_sprite_code:
	...
	LDA $44,x				;$B699F5   |
	JSL interpolate_y_velocity_global	;$B699F7   |
	JSL apply_position_from_velocity_global	;$B699FB   |
...
.return:					;	   |
	...
	JML [sprite_return_address]		;$B69A57  /
...
CODE_B69A82:
	CPX current_held_sprite			;$B69A82  \
...
CODE_B69B30:
	CMP #!sprite_spiked_canballs		;$B69B30  \
...
CODE_B69B45:
	CPX current_held_sprite			;$B69B45  \
...
CODE_B69BD4:
	LDA $42,x				;$B69BD4  \
	JSL interpolate_x_velocity_global	;$B69BD6   |
	LDX current_sprite			;$B69BDA   |
	LDA $44,x				;$B69BDC   |
	JSL interpolate_y_velocity_global	;$B69BDE   |
CODE_B69BE2:					;	   |
	LDX current_sprite			;$B69BE2   |
	LDA $2E,x				;$B69BE4   |
	BIT #$0100				;$B69BE6   |
	BEQ CODE_B69BF7				;$B69BE9   |
	JSL apply_position_from_velocity_global	;$B69BEB   |
...
CODE_B69C37:					;	   |
	PLB					;$B69C37   |
	JML [sprite_return_address]		;$B69C38  /

CODE_B69C3B:
	LDA $30,x				;$B69C3B  \
	ORA #$0001				;$B69C3D   |
	STA $30,x				;$B69C40   |
	LDA current_held_sprite			;$B69C42   |
...
CODE_B69C70:
	LDA $42,x				;$B69C70  \
	JSL interpolate_x_velocity_global	;$B69C72   |
	LDX current_sprite			;$B69C76   |
	LDA $44,x				;$B69C78   |
	JSL interpolate_y_velocity_global	;$B69C7A   |
	JSL apply_position_from_velocity_global	;$B69C7E   |
	JSL delete_sprite_if_offscreen		;$B69C82   |
	RTS					;$B69C86  /
...
CODE_B69C95:					;	   |
	JSL delete_sprite_handle_deallocation	;$B69C95   |
...
CODE_B69C9F:
	LDA current_held_sprite			;$B69C9F  \
...
CODE_B69DC2:
	LDA #$0004				;$B69DC2  \
	JSL interpolate_y_velocity_global	;$B69DC5   |
	JSL apply_position_from_velocity_global	;$B69DC9   |
...
CODE_B69E33:
	JSL apply_position_from_velocity_global	;$B69E33  \
...
CODE_B69F12:
	CPX current_held_sprite			;$B69F12  \
...
CODE_B69F32:
	...
	STA $44,x				;$B69F65   |
CODE_B69F67:					;	   |
	JSL delete_sprite_handle_deallocation	;$B69F67   |
...
CODE_B69FFE:					;	   |
	CPX current_held_sprite			;$B69FFE   |
...
CODE_B6A0B2:
	CPX current_held_sprite			;$B6A0B2  \
...
CODE_B6A13F:
	LDA $42,x				;$B6A13F  \
	JSL interpolate_x_velocity_global	;$B6A141   |
	LDX current_sprite			;$B6A145   |
	LDA $44,x				;$B6A147   |
	JSL interpolate_y_velocity_global	;$B6A149   |
CODE_B6A14D:					;	   |
	LDX current_sprite			;$B6A14D   |
	LDA $2E,x				;$B6A14F   |
	BIT #$0100				;$B6A151   |
	BEQ CODE_B6A162				;$B6A154   |
	JSL apply_position_from_velocity_global	;$B6A156   |
...
CODE_B6A18F:					;	   |
	PLB					;$B6A18F   |
	JML [sprite_return_address]		;$B6A190  /

CODE_B6A193:
	LDA $30,x				;$B6A193  \
	ORA #$0001				;$B6A195   |
	STA $30,x				;$B6A198   |
	LDA current_held_sprite			;$B6A19A   |
...
if !version == 1				;	   |
	...
	STZ current_held_sprite			;$B6A1EC   |
...
CODE_B6A1F7:
	...
	STZ current_held_sprite			;$B6A206   |
...
CODE_B6A211:
	...
	STZ current_held_sprite			;$B6A239   |
...
CODE_B6A280:
	LDA $42,x				;$B6A280  \
	JSL interpolate_x_velocity_global	;$B6A282   |
	LDX current_sprite			;$B6A286   |
	LDA $44,x				;$B6A288   |
	JSL interpolate_y_velocity_global	;$B6A28A   |
	JSL apply_position_from_velocity_global	;$B6A28E   |
...
CODE_B6A2BD:					;	   |
	LDA $42,x				;$B6A2BD   |
	JSL interpolate_x_velocity_global	;$B6A2BF   |
	LDX current_sprite			;$B6A2C3   |
	LDA $44,x				;$B6A2C5   |
	JSL interpolate_y_velocity_global	;$B6A2C7   |
	JSL apply_position_from_velocity_global	;$B6A2CB   |
...
CODE_B6A2E2:
	...
	LDA $4A,x				;$B6A2EA   |
	AND #$00FF				;$B6A2EC   |
	JSL interpolate_x_velocity_global	;$B6A2EF   |
	LDX current_sprite			;$B6A2F3   |
	LDA $4A,x				;$B6A2F5   |
	XBA					;$B6A2F7   |
	AND #$00FF				;$B6A2F8   |
	JSL interpolate_y_velocity_global	;$B6A2FB   |
	JSL apply_position_from_velocity_global	;$B6A2FF   |
	LDX current_sprite			;$B6A303   |
	LDA $06,x				;$B6A305   |
	CMP #$02C0				;$B6A307   |
	BCC CODE_B6A312				;$B6A30A   |
	JSL delete_sprite_handle_deallocation	;$B6A30C   |
...
CODE_B6A317:					;	   |
	...
	LDA.w #sound(6,!sound_barrel_roll)	;$B6A31F   |
	CLC					;$B6A322   |
	JSL queue_or_reset_looping_sound_effect	;$B6A323   |
...
CODE_B6A33E:
	...
	LDA.w #sound(6,!sound_barrel_roll)	;$B6A346   |
	SEC					;$B6A349   |
	JSL queue_or_reset_looping_sound_effect	;$B6A34A   |
...
CODE_B6A378:
	LDA $42,x				;$B6A378  \
	JSL interpolate_x_velocity_global	;$B6A37A   |
	LDX current_sprite			;$B6A37E   |
	LDA $44,x				;$B6A380   |
	JSL interpolate_y_velocity_global	;$B6A382   |
...
CODE_B6A390:
	...
	LDA $44,x				;$B6A398   |
	JSL interpolate_y_velocity_global	;$B6A39A   |
	JSL apply_position_from_velocity_global	;$B6A39E   |
...
krool_misc_sprite_code:
	...
	JML [sprite_return_address]		;$B6A3DA  /

krool_puddle_sprite_code:
	LDA.l $0006A3				;$B6A3DD  \
	BIT #$4000				;$B6A3E1   |
	BEQ .return				;$B6A3E4   |
	JSL delete_sprite_handle_deallocation	;$B6A3E6   |
	JML [sprite_return_address]		;$B6A3EA  /

.return:
	JSL process_sprite_animation		;$B6A3ED  \
	JML [sprite_return_address]		;$B6A3F1  /
...
CODE_B6A434:
	JSL delete_sprite_handle_deallocation	;$B6A434  \
...
tied_up_dk_spawner_sprite_code:
	...
	INC $4E,x				;$B6A458   |
	STX $075F				;$B6A45A   |
	LDY #!special_sprite_spawn_id_011C	;$B6A45D   |
	JSL spawn_special_sprite_index		;$B6A460   |
	LDX alternate_sprite			;$B6A464   |
	STX $075B				;$B6A466   |
	LDA $12,x				;$B6A469   |
	ORA #$4000				;$B6A46B   |
	STA $12,x				;$B6A46E   |
	LDY #!special_sprite_spawn_id_011E	;$B6A470   |
	JSL spawn_special_sprite_index		;$B6A473   |
...
CODE_B6A492:
	JML [sprite_return_address]		;$B6A492  /
...
CODE_B6A510:					;	   |
	...
	JML [sprite_return_address]		;$B6A517  /
...
CODE_B6A536:
	...
	SBC #$0020				;$B6A53B   |
	STA $24,x				;$B6A53E   |
	JSL apply_position_from_velocity_global	;$B6A540   |
	LDX current_sprite			;$B6A544   |
	LDA $0A,x				;$B6A546   |
	CMP #$0100				;$B6A548   |
	BCS CODE_B6A56C				;$B6A54B   |
	PHX					;$B6A54D   |
	JSL delete_sprite_handle_deallocation	;$B6A54E   |
	LDA.l $00075B				;$B6A552   |
	STA current_sprite			;$B6A556   |
	JSL delete_sprite_handle_deallocation	;$B6A558   |
	LDA.l $00075D				;$B6A55C   |
	STA current_sprite			;$B6A560   |
	JSL delete_sprite_handle_deallocation	;$B6A562   |
	PLX					;$B6A566   |
	STX current_sprite			;$B6A567   |
	JML [sprite_return_address]		;$B6A569  /
...
CODE_B6A57C:					;	   |
	LDA #$0003				;$B6A57C   |
	JSL interpolate_y_velocity_global	;$B6A57F   |
	JSL apply_position_from_velocity_global	;$B6A583   |
...
CODE_B6A5A6:					;	   |
	...
	JML [sprite_return_address]		;$B6A5AD  /
...
CODE_B6A668:					;	   |
	...
	JML [sprite_return_address]		;$B6A66C  /
...
CODE_B6A66F:
	...
	JSL delete_sprite_handle_deallocation	;$B6A67D   |
	PLX					;$B6A681   |
...
CODE_B6A6CE:
	LDA #$0004				;$B6A6CE  \
	JSL interpolate_y_velocity_global	;$B6A6D1   |
	JSL apply_position_from_velocity_global	;$B6A6D5   |
...
CODE_B6A6EF:					;	   |
	...
	JML [sprite_return_address]		;$B6A6F3  /
...
.state_0:
	JSL apply_position_from_velocity_global	;$B6A739  \
	LDX $0654				;$B6A73D   |
	LDA $0A,x				;$B6A740   |
	CMP #$0100				;$B6A742   |
	BCS ..return				;$B6A745   |
	...
	JSL delete_sprite_handle_deallocation	;$B6A75C   |
	STZ $0656				;$B6A760   |
	PLX					;$B6A763   |
...
..return:					;	   |
	JML [sprite_return_address]		;$B6A7C9  /
...
.return:					;	   |
	JML [sprite_return_address]		;$B6A835  /
...
boss_splash_and_sparkle_sprite_code:
	LDX current_sprite			;$B6A877  \ Get sprite
	LDA $42,x				;$B6A879   | Get X interpolation preset
	JSL interpolate_x_velocity_global	;$B6A87B   |
	LDX current_sprite			;$B6A87F   | Get sprite
...
CODE_B6A8F0:
	...
	LDA #kleever_hand_sprite_palette	;$B6A8F3   |
	...
	LDA #kleever_hand_sprite_palette	;$B6A924   |
...
CODE_B6A968:
	...
	LDA #kleever_hand_sprite_palette	;$B6A96B   |
	...
	LDA #kleever_hand_sprite_palette	;$B6A99C   |
...
CODE_B6AA6B:
	LDY #!special_sprite_spawn_id_017C	;$B6AA6B  \
	JSL spawn_special_sprite_index		;$B6AA6E   |
...
CODE_B6AAAA:
	LDA #!krool_blinking_eyes_sprite_palette;$B6AAAA  \
	JSL set_sprite_palette_global		;$B6AAAD   |
	LDY #!special_sprite_spawn_id_0158	;$B6AAB1   |
	JSL spawn_special_sprite_index		;$B6AAB4   |
...
CODE_B6ABCB:
	...
	JSL delete_sprite_handle_deallocation	;$B6ABD6   |
	STZ $0733				;$B6ABDA   |
CODE_B6ABDD:					;	   |
	LDX $0654				;$B6ABDD   |
	STX current_sprite			;$B6ABE0   |
	LDA #!krool_sprite_palette		;$B6ABE2   |
...
CODE_B6AD3A:					;	   |
	LDY $0002,x				;$B6AD3A   |
	PHX					;$B6AD3D   |
	JSL spawn_no_gfx_special_sprite_address	;$B6AD3E   |
	PLY					;$B6AD42   |
...
CODE_B6AE55:					;	   |
	...
	STZ $24,x				;$B6AE61   |
	LDA #$0005				;$B6AE63   |
	JSL interpolate_x_velocity_global	;$B6AE66   |
	LDA #$0005				;$B6AE6A   |
	JSL interpolate_y_velocity_global	;$B6AE6D   |
	PLB					;$B6AE71   |
	RTL					;$B6AE72  /
...
boss_command_code_3F:
	...
	LDA.l $00074F				;$B6BB82   |
	CMP current_held_sprite			;$B6BB86   |
	BNE CODE_B6BB8E				;$B6BB89   |
	STZ current_held_sprite			;$B6BB8B   |
CODE_B6BB8E:					;	   |
	STZ $074F				;$B6BB8E   |
	LDX $0654				;$B6BB91   |
	STZ $44,x				;$B6BB94   |
...
CODE_B6BC49:					;	   |
	LDA.l $000749				;$B6BC49   |
	JSL interpolate_y_velocity_global	;$B6BC4D   |
	JSL apply_position_from_velocity_global	;$B6BC51   |
...
CODE_B6BD32:					;	   |
	...
	LDA.l $00074F				;$B6BD60   |
	STZ $074F				;$B6BD64   |
	CMP current_held_sprite			;$B6BD67   |
...
CODE_B6BF19:
	...
	AND #$FEFF				;$B6BF1E   |
	STA $0006A3				;$B6BF21   |
	LDY #!special_sprite_spawn_id_017C	;$B6BF25   |
	JSL spawn_special_sprite_index		;$B6BF28   |
...
CODE_B6C0FF:
	...
	JSL delete_sprite_handle_deallocation	;$B6C105   |
	LDA.w #sound(7,!sound_krool_suck_whoosh);$B6C109   |
	CLC					;$B6C10C   |
	JSL queue_or_reset_looping_sound_effect	;$B6C10D   |
	LDA.w #sound(4,!sound_krool_suck_vroom)	;$B6C111   |
	CLC					;$B6C114   |
	JSL queue_or_reset_looping_sound_effect	;$B6C115   |
	LDX $0654				;$B6C119   |
...
CODE_B6C1A4:
	LDA.w #sound(7,!sound_krool_suck_whoosh);$B6C1A4  \
	SEC					;$B6C1A7   |
	JSL queue_or_reset_looping_sound_effect	;$B6C1A8   |
	LDA.w #sound(4,!sound_krool_suck_vroom)	;$B6C1AC   |
	SEC					;$B6C1AF   |
	JSL queue_or_reset_looping_sound_effect	;$B6C1B0   |
...
CODE_B6C28F:
	LDY #!special_sprite_spawn_id_017C	;$B6C28F  \
	JSL spawn_special_sprite_index		;$B6C292   |
...
CODE_B6C389:
	LDA.l $000723				;$B6C389  \
	JSL interpolate_x_velocity_global	;$B6C38D   |
	JSL apply_position_from_velocity_global	;$B6C391   |
...
CODE_B6C3BE:
	...
	JSL delete_sprite_handle_deallocation	;$B6C3C9   |
	LDA.l $000654				;$B6C3CD   |
	...
	CLC					;$B6C3F3   |
	JSL queue_or_reset_looping_sound_effect	;$B6C3F4   |
	LDX current_sprite			;$B6C3F8   |
	BRA CODE_B6C435				;$B6C3FA  /

CODE_B6C3FC:
	LDA.w #sound(7,!sound_krool_exhaust)	;$B6C3FC  \
	SEC					;$B6C3FF   |
	JSL queue_or_reset_looping_sound_effect	;$B6C400   |
...
CODE_B6C421:					;	   |
	JSL spawn_no_gfx_special_sprite_address	;$B6C421   |
...
CODE_B6C543:					;	   |
	...
	JSL spawn_no_gfx_special_sprite_address	;$B6C547   |
	PLY					;$B6C54B   |
...
boss_command_code_15:
	...
	JSL spawn_special_sprite_address	;$B6C69A   |
...
klubba_sprite_code:
	...
	LDY #!special_sprite_spawn_id_010C	;$B6D037   |\ Else spawn the club sprite
	JSL spawn_special_sprite_index		;$B6D03A   |/
...
.dont_attack					;	   |
	...
	PLB					;$B6D06A   |
	JML [sprite_return_address]		;$B6D06B  /
...
bank_B6_sprite_main_handler_2:
	TAX					;$B6D171  \
	PHK					;$B6D172   |
	PLB					;$B6D173   |
	JMP (.main_table,x)			;$B6D174  /
...
CODE_B6D1B4:
	...
	STA $4E,x				;$B6D23A   |
	LDA #$0005				;$B6D23C   |
	JSL interpolate_x_velocity_global	;$B6D23F   |
	LDA #$0005				;$B6D243   |
	JSL interpolate_y_velocity_global	;$B6D246   |
...
CODE_B6D2F8:					;	   |
	PLB					;$B6D2F8   |
	JML [sprite_return_address]		;$B6D2F9  /

CODE_B6D2FC:
	JSL delete_sprite_handle_deallocation	;$B6D2FC  \
...
CODE_B6D302:
	...
	STA $2A,x				;$B6D315   |
	LDA $22,x				;$B6D317   |
	JSL interpolate_x_velocity_global	;$B6D319   |
	LDX current_sprite			;$B6D31D   |
	LDA $22,x				;$B6D31F   |
	JSL interpolate_y_velocity_global	;$B6D321   |
	JSL apply_position_from_velocity_global	;$B6D325   |
CODE_B6D329:					;	   |
	LDA $2E,x				;$B6D329   |
	ORA #$4000				;$B6D32B   |
	STA $2E,x				;$B6D32E   |
...
CODE_B6D358:
	...
	LDY $44,x				;$B6D360   |
	LDA $0000,y				;$B6D362   |
	CMP #!sprite_kleever_canball		;$B6D365   |
	BEQ CODE_B6D390				;$B6D368   |
	CMP #!sprite_kleever_falling_canball	;$B6D36A   |
...
CODE_B6D5D4:					;	   |
	...
	STA $22,x				;$B6D5DB   |
	LDA $22,x				;$B6D5DD   |
	JSL interpolate_x_velocity_global	;$B6D5DF   |
	LDX current_sprite			;$B6D5E3   |
	LDA $22,x				;$B6D5E5   |
	JSL interpolate_y_velocity_global	;$B6D5E7   |
	JSL apply_position_from_velocity_global	;$B6D5EB   |
...
CODE_B6D72B:					;	   |
	...
	STA $2A,x				;$B6D73E   |
	LDA $22,x				;$B6D740   |
	JSL interpolate_x_velocity_global	;$B6D742   |
	LDX current_sprite			;$B6D746   |
	LDA $22,x				;$B6D748   |
	JSL interpolate_y_velocity_global	;$B6D74A   |
	BRA CODE_B6D79B				;$B6D74E  /

CODE_B6D750:
	LDA $22,x				;$B6D750  \
	JSL interpolate_x_velocity_global	;$B6D752   |
...
CODE_B6D798:					;	   |
	STA $0044,y				;$B6D798   |
CODE_B6D79B:					;	   |
	JSL apply_position_from_velocity_global	;$B6D79B   |
...
CODE_B6D929:
	...
	LDY $0000,x				;$B6D937   |
	PHX					;$B6D93A   |
	JSL spawn_no_gfx_special_sprite_address	;$B6D93B   |
	PLY					;$B6D93F   |
...
CODE_B6DA4C:
	LDA $22,x				;$B6DA4C  \
	JSL interpolate_x_velocity_global	;$B6DA4E   |
	LDX current_sprite			;$B6DA52   |
	LDA $22,x				;$B6DA54   |
	JSL interpolate_y_velocity_global	;$B6DA56   |
	JSL apply_position_from_velocity_global	;$B6DA5A   |
CODE_B6DA5E:					;	   |
	RTS					;$B6DA5E  /
...
CODE_B6DA7F:
	LDA #$000B				;$B6DA7F  \
	JSL interpolate_x_velocity_global	;$B6DA82   |
	LDX current_sprite			;$B6DA86   |
	LDA $22,x				;$B6DA88   |
	JSL interpolate_y_velocity_global	;$B6DA8A   |
	JSL apply_position_from_velocity_global	;$B6DA8E   |
CODE_B6DA92:					;	   |
	RTS					;$B6DA92  /
...
CODE_B6DA9C:					;	   |
	LDA $22,x				;$B6DA9C   |
	JSL interpolate_x_velocity_global	;$B6DA9E   |
	LDX current_sprite			;$B6DAA2   |
	LDA $22,x				;$B6DAA4   |
	JSL interpolate_y_velocity_global	;$B6DAA6   |
	JSL apply_position_from_velocity_global	;$B6DAAA   |
	RTS					;$B6DAAE  /
...
CODE_B6DCBF:					;	   |
	...
	LDA #$C000				;$B6DCDA   |
	STA $1C,x				;$B6DCDD   |
	LDY #!special_sprite_spawn_id_015C	;$B6DCDF   |
	JSL spawn_special_sprite_index		;$B6DCE2   |
	...
	STZ $24,x				;$B6DCFA   |
	STZ $20,x				;$B6DCFC   |
	LDY #!special_sprite_spawn_id_015A	;$B6DCFE   |
	JSL spawn_special_sprite_index		;$B6DD01   |
...
CODE_B6DD6D:
	...
	PLB					;$B6DD6F   |
	STX $0650				;$B6DD70   |
	LDY #!special_sprite_spawn_id_00AA	;$B6DD73   |
	JSL spawn_special_sprite_index		;$B6DD76   |
...
kleever_fireballs_sprite_code:
	JSL delete_sprite_if_offscreen		;$B6DE34  \
...
CODE_B6DE66:
	...
	STZ current_held_sprite			;$B6DE85   |
CODE_B6DE88:					;	   |
...
CODE_B6DF86:					;	   |
	XBA					;$B6DF86   |
	STA $0020,y				;$B6DF87   |
	JSL delete_sprite_handle_deallocation	;$B6DF8A   |
	BRA CODE_B6DF9C				;$B6DF8E  /

CODE_B6DF90:
	LDA.w #sound(6,!sound_kleever_fireball)	;$B6DF90  \
	SEC					;$B6DF93   |
	JSL queue_or_reset_looping_sound_effect	;$B6DF94   |
	JSL process_sprite_animation		;$B6DF98   |
CODE_B6DF9C:					;	   |
	JML [sprite_return_address]		;$B6DF9C  /
...
CODE_B6E033:					;	   |
	...
	JSL spawn_no_gfx_special_sprite_address	;$B6E037   |
	PLY					;$B6E03B   |
...
CODE_B6E10A:
	...
	JSL get_sprite_position_in_level_data	;$B6E10E   |
...
CODE_B6E178:					;	   |
	LDA #$0003				;$B6E178   |
	JSL interpolate_y_velocity_global	;$B6E17B   |
	JSL apply_position_from_velocity_global	;$B6E17F   |
	LDA.l $0006A3				;$B6E183   |
	BIT #$0004				;$B6E187   |
...
CODE_B6E195:					;	   |
	JML [sprite_return_address]		;$B6E195  /
...
CODE_B6E1AC:
	LDA #$0005				;$B6E1AC  \
	JSL interpolate_y_velocity_global	;$B6E1AF   |
	JSL apply_position_from_velocity_global	;$B6E1B3   |
CODE_B6E1B7:					;	   |
	LDA.l $0006A3				;$B6E1B7   |
	BIT #$0004				;$B6E1BB   |
...
CODE_B6E1C4:					;	   |
	JML [sprite_return_address]		;$B6E1C4  /
...
CODE_B6E1E5:					;	   |
	JML [sprite_return_address]		;$B6E1E5  /
...
CODE_B6E1F2:					;	   |
	...
	LDA #$0003				;$B6E1FB   |
	JSL interpolate_y_velocity_global	;$B6E1FE   |
	JSL apply_position_from_velocity_global	;$B6E202   |
	LDA.l $0006A3				;$B6E206   |
	BIT #$0004				;$B6E20A   |
	BEQ CODE_B6E213				;$B6E20D   |
	JSL CODE_BBBB99				;$B6E20F   |
CODE_B6E213:					;	   |
	JML [sprite_return_address]		;$B6E213  /

CODE_B6E216:
	JSL delete_sprite_handle_deallocation	;$B6E216  \
	JML [sprite_return_address]		;$B6E21A  /
...
CODE_B6E23B:					;	   |
	JML [sprite_return_address]		;$B6E23B  /
...
CODE_B6E258:					;	   |
	JML [sprite_return_address]		;$B6E258  /
...
CODE_B6E26E:					;	   |
	JML [sprite_return_address]		;$B6E26E  /
...
CODE_B6E353:					;	   |
	...
	JSL delete_sprite_handle_deallocation	;$B6E374   |
	PLX					;$B6E378   |
...
kleever_canball_sprite_code:
	...
	LDA $54,x				;$B6E4A3   |
	STA current_sprite_constants		;$B6E4A5   |
	LDA $2E,x				;$B6E4A7   |
	ASL A					;$B6E4A9   |
	TAX					;$B6E4AA   |
...
CODE_B6E4BC:
	JSL delete_sprite_handle_deallocation	;$B6E4BC  \
	PLB					;$B6E4C0   |
	JML [sprite_return_address]		;$B6E4C1  /

CODE_B6E4C4:
	JSL delete_sprite_if_offscreen		;$B6E4C4  \
...
CODE_B6E4CF:
	LDA #$0002				;$B6E4CF  \
	JSL interpolate_x_velocity_global	;$B6E4D2   |
	LDA #$0004				;$B6E4D6   |
...
CODE_B6E500:					;	   |
	PLB					;$B6E500   |
	JML [sprite_return_address]		;$B6E501  /
...
CODE_B6E53C:
	LDA current_held_sprite			;$B6E53C  \
...
CODE_B6E559:					;	   |
	PLB					;$B6E559   |
	JML [sprite_return_address]		;$B6E55A  /
...
CODE_B6E5B9:					;	   |
	STZ current_held_sprite			;$B6E5B9   |
...
CODE_B6E5C8:
	...
	STA $02,x				;$B6E5D0   |
	LDY #$0006				;$B6E5D2   |
	LDA [current_sprite_constants],y	;$B6E5D5   |
	BIT $20,x				;$B6E5D7   |
...
CODE_B6E604:
	...
	JSL delete_sprite_handle_deallocation	;$B6E61D   |
	LDY #!special_sprite_spawn_id_0152	;$B6E621   |
	JSL spawn_special_sprite_index		;$B6E624   |
	BRA CODE_B6E630				;$B6E628  /

CODE_B6E62A:
	JSL delete_sprite_if_offscreen		;$B6E62A  \
...
CODE_B6E677:
	LDY #$0006				;$B6E677  \
	LDA [current_sprite_constants],y	;$B6E67A   |
	BIT $12,x				;$B6E67C   |
...
CODE_B6E69B:					;	   |
	PLB					;$B6E69B   |
	JML [sprite_return_address]		;$B6E69C  /
...
kleever_hand_bubbles_sprite_code:
	...
	JML [sprite_return_address]		;$B6E7A2  / Done processing sprite
...
kleever_hand_sprite_code:
	...
	CMP #$0005				;$B6E7B2   |
	BEQ .return				;$B6E7B5   |
	LDA.l $000652				;$B6E7B7   | Get Kleever hit points
	BNE .kleever_alive			;$B6E7BB   |
	BRL .return				;$B6E7BD  / If dead, return
...
CODE_B6E80D:
	LDA.w #sound(7,!sound_lava_bubble_1)	;$B6E80D  \
	SEC					;$B6E810   |
	JSL queue_or_reset_looping_sound_effect	;$B6E811   |
	LDX $0656				;$B6E815   |
	LDA $42,x				;$B6E818   |
...
CODE_B6E83F:					;	   |
	...
	JSL delete_sprite_handle_deallocation	;$B6E850   |
	STZ $0759				;$B6E854   |
	LDA.l $000654				;$B6E857   |
...
CODE_B6E85D:					;	   |
	...
	JSL delete_sprite_handle_deallocation	;$B6E869   |
	STZ $0656				;$B6E86D   |
	LDX $0654				;$B6E870   |
	...
	LDX $0654				;$B6E8A3   |
	STZ $4C,x				;$B6E8A6   |
	LDY #!special_sprite_spawn_id_0152	;$B6E8A8   |
	JSL spawn_special_sprite_index		;$B6E8AB   |
	LDY #!special_sprite_spawn_id_0154	;$B6E8AF   |
...
kleever_falling_canball_sprite_code:
	...
	LDA $0054,y				;$B6E97E   |
	STA current_sprite_constants		;$B6E981   |
	LDA $002E,y				;$B6E983   |
	AND #$00FF				;$B6E986   |
	ASL A					;$B6E989   |
	TAX					;$B6E98A   |
...
CODE_B6E9AF:					;	   |
	...
	JML [sprite_return_address]		;$B6E9B3  /
...
CODE_B6E9CC:					;	   |
	...
	JML [sprite_return_address]		;$B6E9D0  /

CODE_B6E9D3:
	TYX					;$B6E9D3  \
	LDY $4E,x				;$B6E9D4   |
	JSL apply_spawn_script_to_slot_global	;$B6E9D6   |
	JML [sprite_return_address]		;$B6E9DA  /

kleever_attack_effect_sprite_code:
	JSL process_sprite_animation		;$B6E9DD  \ Process animation
	JML [sprite_return_address]		;$B6E9E1  / Return
...
.CODE_B6EA11:					;	   |
	...
	PLB					;$B6EA12   |
	LDA $46,x				;$B6EA13   |
	JSL interpolate_x_velocity_global	;$B6EA15   |
	LDX current_sprite			;$B6EA19   |
	LDA $48,x				;$B6EA1B   |
	JSL interpolate_y_velocity_global	;$B6EA1D   |
	JSL apply_position_from_velocity_global	;$B6EA21   |
	...
	LDA $0A,x				;$B6EA34   |
	CMP #$02F0				;$B6EA36   |
	BCC .return_plb				;$B6EA39   |
	PHX					;$B6EA3B   |
	JSL delete_sprite_handle_deallocation	;$B6EA3C   |
	LDY $0656				;$B6EA40   |
	STY current_sprite			;$B6EA43   |
	JSL delete_sprite_handle_deallocation	;$B6EA45   |
	PLX					;$B6EA49   |
	STX current_sprite			;$B6EA4A   |
	LDY #!special_sprite_spawn_id_0152	;$B6EA4C   |
	JSL spawn_special_sprite_index		;$B6EA4F   |
	LDY #!special_sprite_spawn_id_0154	;$B6EA53   |
...
.return_plb:					;	   |
	PLB					;$B6EA71   |
.return:					;	   |
	JML [sprite_return_address]		;$B6EA72  /

.CODE_B6EA75:
	JSL set_current_level_as_cleared	;$B6EA75  \
	JSL delete_sprite_handle_deallocation	;$B6EA79   |
	BRA .return_plb				;$B6EA7D  /
...
.return:					;	   |
	JML [sprite_return_address]		;$B6EAB5  /
...
.CODE_B6EB7F:					;	   |
	LDA $42,x				;$B6EB7F   |
	JSL interpolate_x_velocity_global	;$B6EB81   |
	...
	CMP #$00E0				;$B6EBA3   |
	BMI .return				;$B6EBA6   |
	JSL delete_sprite_handle_deallocation	;$B6EBA8   |
.return:					;	   |
	JML [sprite_return_address]		;$B6EBAC  /
...
CODE_B6ECB4:
	JSL delete_sprite_handle_deallocation	;$B6ECB4  \
...
CODE_B6ED21:
	...
	JSL spawn_special_sprite_address	;$B6ED35   |
...
CODE_B6F038:					;	   |
	JSL delete_sprite_handle_deallocation	;$B6F038   |
	LDA $2E,x				;$B6F03C   |
	BIT #$0080				;$B6F03E   |
...
CODE_B6F055:					;	   |
	PLB					;$B6F055   |
	JML [sprite_return_address]		;$B6F056  /
...
CODE_B6F12C:					;	   |
	...
	STZ current_held_sprite			;$B6F155   |
	LDA #$FFEF				;$B6F158   |
	AND $2E,x				;$B6F15B   |
	STA $2E,x				;$B6F15D   |
...
CODE_B6F1C2:
	STZ current_held_sprite			;$B6F1C2  \
	LDA #$FFEF				;$B6F1C5   |
	AND $2E,x				;$B6F1C8   |
	STA $2E,x				;$B6F1CA   |
	LDY $0654				;$B6F1CC   |
	...
	JSL delete_sprite_handle_deallocation	;$B6F1E6   |
...
CODE_B6F27A:					;	   |
	LDY $0002,x				;$B6F27A   |
	PHX					;$B6F27D   |
	JSL spawn_no_gfx_special_sprite_address	;$B6F27E   |
	PLY					;$B6F282   |
...
CODE_B6F68E:					;	   |
	PLB					;$B6F68E   |
	JML [sprite_return_address]		;$B6F68F  /
...
CODE_B6F824:					;	   |
	...
	JML [sprite_return_address]		;$B6F82A  /
...
CODE_B6F8F3:
	...
	JSL delete_sprite_handle_deallocation	;$B6F8FA   |
	PLX					;$B6F8FE   |
...
;This routine calculates the position offset that the hit star sprite should use
;in relation to the current colliding sprite and what it just collided with, and spawns it
CODE_B6FE9E:
...
CODE_B6FEA2:
	...
	JSL spawn_special_sprite_address	;$B6FEB1   |
