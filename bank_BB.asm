...
CODE_BB80BA:					;	   |
	STZ $B0					;$BB80BA   |
	STZ $B2					;$BB80BC   |
	LDX #main_level				;$BB80BE   |
	JSL CODE_BBAF0F				;$BB80C1   |
	LDA main_level.type			;$BB80C5   |
...
CODE_BB80D7:					;	   |
	PHX					;$BB80D7   |
	LDA main_level.destinations,x		;$BB80D8   |
	BEQ CODE_BB8103				;$BB80DB   |
	LDX #alt_level				;$BB80DD   |
	JSL CODE_BBAF0F				;$BB80E0   |
	LDA alt_level.type			;$BB80E4   |
	CMP #!bonus_level_type			;$BB80E7   |
	BNE CODE_BB8103				;$BB80EA   |
	LDA alt_level.bonus_type		;$BB80EC   |
	AND #$00FF				;$BB80EF   |
	BEQ CODE_BB8103				;$BB80F2   |
	INC $B2					;$BB80F4   |
	PLX					;$BB80F6   |
	LDA main_level.destinations,x		;$BB80F7   |
	PHX					;$BB80FA   |
...
.CODE_BB81E3:					;	   |
	...
	LDA visited_kong_family_members		;$BB8235   |
...
.scan_for_free_slot:				;	   |
	LDA sprite_vram_allocation_table,y	;$BB831B   | Check if the slot being checked is free
...
.free_slot_found:
	...
	STA sprite_vram_allocation_table,y	;$BB832E   | Store index of sprite we want to spawn in the table
...
.CODE_BB838C:					;	   |
	...
	LDX #$0000				;$BB8399   |
CODE_BB839C:					;	   |
	LDA sprite_vram_allocation_table,y	;$BB839C   |
...
deallocate_sprite_vram_slot:
	...
	TAY					;$BB83BD   |
	LDA #$0000				;$BB83BE   |
	STA sprite_vram_allocation_table,y	;$BB83C1   |
	RTS					;$BB83C4  /
...
deallocate_big_sprite_vram_slot:
	...
	LSR A					;$BB83CD   |
	TAY					;$BB83CE   |
	LDA sprite_vram_allocation_table,y	;$BB83CF   |
	CMP sprite_vram_allocation_table+$2,y	;$BB83D2   |
	BNE .slot_mismatch			;$BB83D5   |
	LDA #$0000				;$BB83D7   |
	STA sprite_vram_allocation_table,y	;$BB83DA   |
	STA sprite_vram_allocation_table+$2,y	;$BB83DD   |
	RTS					;$BB83E0  /

.slot_mismatch:
	LDA #$0000				;$BB83E1  \
	STA sprite_vram_allocation_table,y	;$BB83E4   |
	LDA #$0004				;$BB83E7   |
...
init_command_set_oam_special:
	...
	LDA.l main_level.effects		;$BB8620   |
	AND #!door_occlusion_effect		;$BB8624   |
...
CODE_BB876F:
	...
	LDA current_palette_buffer_slot		;$BB8778   |
	DEC A					;$BB877A   |
	AND #$000F				;$BB877B   |
	STA current_palette_buffer_slot		;$BB877E   |
CODE_BB8780:					;	   |
...
CODE_BB8838:
	...
	LDA current_palette_buffer_slot		;$BB8841   |
	DEC A					;$BB8843   |
	AND #$000F				;$BB8844   |
	STA current_palette_buffer_slot		;$BB8847   |
CODE_BB8849:					;	   |
...
request_palette_direct:				;	   |
	STA selected_palette_data_address	;$BB8A6F   |> Preserve requested palette address
	LDX #$0000				;$BB8A72   |> Start with palette slot 0
.next_slot					;	   |
	LDA active_sprite_palettes_table,x	;$BB8A75   |\
	BEQ .free_slot_found			;$BB8A78   |/ If current slot is free
	CMP selected_palette_data_address	;$BB8A7A   |\ Else
...
.slot_not_free					;	   |
	...
	LDA selected_palette_data_address	;$BB8A8D   |\
	STA exception_palette_address		;$BB8A90   |/ Save palette that caused the overflow
	LDX #$0000				;$BB8A93   |> Use the palette in slot 0 instead
	INC sprite_palette_reference_count,x	;$BB8A96   |> Update reference count
	TXA					;$BB8A99   |\
	XBA					;$BB8A9A   | |
	CLC					;$BB8A9B   | |
...
.existing_palette_found
	LDA sprite_palette_reference_count,x	;$BB8AA1  \ \ If palette slot isnt allowed to share
...
.next_slot_after
	LDA active_sprite_palettes_table,x	;$BB8AAC  \ \
	CMP selected_palette_data_address	;$BB8AAF   | | If requested address matches address in slot
...
.palette_found_after_free_slot
	LDA sprite_palette_reference_count,x	;$BB8ABD  \ \ If palette slot isnt allowed to share
	BMI .scan_ahead_for_existing_palette	;$BB8AC0   |/ Then find a new slot
.slot_found					;	   |
	INC sprite_palette_reference_count,x	;$BB8AC2   |> Add reference to existing palette slot
	TXA					;$BB8AC5   |\
...
CODE_BB8AE4:
	STA selected_palette_data_address	;$BB8AE4  \
	LDA sprite.oam_property,x		;$BB8AE7   |
	XBA					;$BB8AE9   |
	AND #$000E				;$BB8AEA   |
	STA $5E					;$BB8AED   |
	JSR CODE_BB8AF6				;$BB8AEF   |
	DEC sprite_palette_reference_count,x	;$BB8AF2   |
	RTL					;$BB8AF5  /

CODE_BB8AF6:
	LDA main_level.effects			;$BB8AF6  \
	AND #!inverted_sprite_palette_effect	;$BB8AF9   |
	BNE .use_inverted_sprite_palette	;$BB8AFC   |
	LDA current_palette_buffer_slot		;$BB8AFE   |
	ASL A					;$BB8B00   |
	ASL A					;$BB8B01   |
	TAX					;$BB8B02   |
	JSR CODE_BB8B66				;$BB8B03   |
	STA palette_upload_ring_buffer,x	;$BB8B06   |
	LDA $5E					;$BB8B09   |
	ASL A					;$BB8B0B   |
	ASL A					;$BB8B0C   |
	ASL A					;$BB8B0D   |
	...
	STA palette_upload_ring_buffer+$2,x	;$BB8B16   |
	LDA current_palette_buffer_slot		;$BB8B19   |
	INC A					;$BB8B1B   |
	AND #$000F				;$BB8B1C   |
	STA current_palette_buffer_slot		;$BB8B1F   |
	LDX $5E					;$BB8B21   |
	INC sprite_palette_reference_count,x	;$BB8B23   |
	LDA selected_palette_data_address	;$BB8B26   |
	STA active_sprite_palettes_table,x	;$BB8B29   |
	TXA					;$BB8B2C   |
	XBA					;$BB8B2D   |
	CLC					;$BB8B2E   |
	RTS					;$BB8B2F  /
...
.use_inverted_sprite_palette:
	LDA current_palette_buffer_slot		;$BB8B30  \
	ASL A					;$BB8B32   |
	ASL A					;$BB8B33   |
	TAX					;$BB8B34   |
	...
	INC A					;$BB8B51   |
	AND #$000F				;$BB8B52   |
	STA current_palette_buffer_slot		;$BB8B55   |
	LDX $5E					;$BB8B57   |
	INC sprite_palette_reference_count,x	;$BB8B59   |
	LDA selected_palette_data_address	;$BB8B5C   |
	STA active_sprite_palettes_table,x	;$BB8B5F   |
	TXA					;$BB8B62   |
	XBA					;$BB8B63   |
	CLC					;$BB8B64   |
	RTS					;$BB8B65  /
...
CODE_BB8B66:
	...
	STA $60					;$BB8B7A   |
.CODE_BB8B7C					;	   |
	LDA selected_palette_data_address	;$BB8B7C   |
...
.no_gas_effect
	LDA #$001E				;$BB8B9F  \
	CLC					;$BB8BA2   |
	ADC selected_palette_data_address	;$BB8BA3   |
	CLC					;$BB8BA6   |
	ADC $60					;$BB8BA7   |
	RTS					;$BB8BA9  /

.dixie_palette
	LDA active_kong_number			;$BB8BAA  \
...
.purple_gas_effect				;	   |
	LDA #$00B4				;$BB8BC2   |
	CLC					;$BB8BC5   |
	ADC selected_palette_data_address	;$BB8BC6   |
	RTS					;$BB8BC9  /

.CODE_BB8BCA
	LDA selected_palette_data_address	;$BB8BCA  \
	CLC					;$BB8BCD   |
	ADC $60					;$BB8BCE   |
	RTS					;$BB8BD0  /
...
.blue_gas_effect
	LDA #$0078				;$BB8BD1  \
	CLC					;$BB8BD4   |
	ADC selected_palette_data_address	;$BB8BD5   |
	RTS					;$BB8BD8  /

.red_gas_effect
	LDA #$0096				;$BB8BD9  \
	CLC					;$BB8BDC   |
	ADC selected_palette_data_address	;$BB8BDD   |
	RTS					;$BB8BE0  /

.invincibility_effect
	LDA #$00D2				;$BB8BE1  \
	CLC					;$BB8BE4   |
	ADC selected_palette_data_address	;$BB8BE5   |
	RTS					;$BB8BE8  /
...
dereference_sprite_palette:
	...
	TAX					;$BB8C0A   |/
	DEC sprite_palette_reference_count,x	;$BB8C0B   |> Decrease palette reference count
...
.empty_slot:
	STZ active_sprite_palettes_table,x	;$BB8C14  \ Clear palette address from table
...
CODE_BB8C19:
	...
	AND #$000E				;$BB8C1F   |
	TAX					;$BB8C22   |
	LDA active_sprite_palettes_table,x	;$BB8C23   |
...
CODE_BB8C2C:					;	   |
	...
	AND #$000E				;$BB8C32   |
	TAX					;$BB8C35   |
	LDA active_sprite_palettes_table,x	;$BB8C36   |
...
set_sprite_palette_direct:			;	   |
	TXY					;$BB8C50   |
	STA selected_palette_data_address	;$BB8C51   |
	LDA sprite.oam_property,x		;$BB8C54   |
	XBA					;$BB8C56   |
	AND #$000E				;$BB8C57   |
	TAX					;$BB8C5A   |
	LDA active_sprite_palettes_table,x	;$BB8C5B   |
	CMP #global_sprite_palette		;$BB8C5E   |
	BNE CODE_BB8C68				;$BB8C61   |
	DEC sprite_palette_reference_count,x	;$BB8C63   |
...
CODE_BB8C6E:					;	   |
	LDA selected_palette_data_address	;$BB8C6E   |
...
if !version == 0				;	   |
	...
	TRB game_state_flags			;$BB921B   |
if !version == 0				;	   |
	LDA #$0002				;$BB921E   |
else						;	   |
	LDA #$0012				;$BB921E   |
endif						;	   |
	TRB game_state_flags_2			;$BB9221   |
	LDA active_kong_number			;$BB9224   |
...
CODE_BB9252:					;	   |
	...
	LDA #$0080				;$BB925A   |
	TRB game_state_flags			;$BB925D   |
	BEQ CODE_BB9265				;$BB9260   |
	JSR CODE_BBBDA1				;$BB9262   |
CODE_BB9265:					;	   |
	LDA #$A002				;$BB9265   |
	TRB game_state_flags			;$BB9268   |
	STZ $17C8				;$BB926B   |
	...
	LDA cheat_enable_flags			;$BB9287   |
	AND #$0001				;$BB928A   |
	BEQ CODE_BB929D				;$BB928D   |
	LDA main_level.type			;$BB928F   |
...
CODE_BB929D:					;	   |
	...
	LDA main_level.bonus_type		;$BB92B7   |\ Get bonus type
	AND #$00FF				;$BB92BA   | |
...
.done_handling_stars:				;	   |
	...
	LDA main_level.effects			;$BB92D2   | Get level effect flags
	AND #!no_tilemap_effect			;$BB92D5   |
	BNE CODE_BB9310				;$BB92D8   |
	LDA $0B86				;$BB92DA   | Get 32x32 tilemap compression flag
	AND #$0400				;$BB92DD   |
	BEQ .uncompressed_tilemap		;$BB92E0   | Skip decompression if flag not set
	LDA $98					;$BB92E2   |\ Else load address of 32x32 tilemap
	TAX					;$BB92E4   | |
...
CODE_BB938B:
	...
	CMP checkpoint_level_number		;$BB9395   |
...
CODE_BB939B:
	...
	CMP checkpoint_level_number		;$BB939D   |
	BNE CODE_BB939A				;$BB93A0   |
CODE_BB93A2:					;	   |
	LDA level_entrance_number		;$BB93A2   |
	BNE CODE_BB939A				;$BB93A5   |
	LDA checkpoint_level_number		;$BB93A7   |
	STA level_number			;$BB93AA   |
	LDA checkpoint_level_entrance_number	;$BB93AC   |
	STA level_entrance_number		;$BB93AF   |
	LDA checkpoint_animal_type		;$BB93B2   |
	STA animal_type				;$BB93B5   |
	STZ current_player_mount		;$BB93B7   |
	LDA checkpoint_collected_kong_letters	;$BB93B9   |
	STA collected_kong_letters		;$BB93BC   |
	RTS					;$BB93BF  /
...
CODE_BB93FE:
	LDA main_level.type			;$BB93FE  \
	CMP #!bonus_level_type			;$BB9401   |
	BNE CODE_BB940C				;$BB9404   |
	LDA main_level.bonus_type		;$BB9406   |
...
CODE_BB9424:
	...
	LDA exiting_sub_level_flag		;$BB9436   |
	BMI CODE_BB9473				;$BB9439   |
CODE_BB943B:					;	   |
	LDA main_level.song			;$BB943B   |
CODE_BB943E:					;	   |
	AND #$00FF				;$BB943E   |
CODE_BB9441:					;	   |
...
CODE_BB9446:
	LDA main_level.bonus_type		;$BB9446  \
	AND #$00FF				;$BB9449   |
...
CODE_BBABF4:					;	   |
	...
	STA $0D52				;$BBAC19   |
	LDA #$8000				;$BBAC1C   |
	STA water_current_y_velocity		;$BBAC1F   |
	RTS					;$BBAC22  /
...
CODE_BBAC23:
	...
	STA $0D54				;$BBAC27   |
	LDA #$FF40				;$BBAC2A   |
	STA water_current_y_velocity		;$BBAC2D   |
	STA water_target_y_velocity		;$BBAC30   |
	LDA #$012B				;$BBAC33   |
	STA $0D52				;$BBAC36   |
	LDA game_state_flags			;$BBAC39   |
	STA $0D56				;$BBAC3C   |
	RTS					;$BBAC3F  /
...
CODE_BBAE92:
	LDA main_level.entrance_direction	;$BBAE92  \
	AND #$0002				;$BBAE95   |
...
set_kong_spawn_position:
	...
	LDA main_level.entrance_x		;$BBAEB2   |
	STA $06,x				;$BBAEB5   |
	LDA main_level.entrance_y		;$BBAEB7   |
	STA $0A,x				;$BBAEBA   |
	RTS					;$BBAEBC  /
...
.dixie:
	LDA #!dixie_active_sprite_palette	;$BBAEE3  \
	JSR request_sprite_palette		;$BBAEE6   |
	BRA .set_palette_slot			;$BBAEE9  /

.request_animal_palette:
	STA temp_32				;$BBAEEB  \ Preserve animal ID
	LDA current_player_mount		;$BBAEED   |
	BNE .request_kong_palette		;$BBAEEF   |
	LDA temp_32				;$BBAEF1   | Retrieve animal ID
	SEC					;$BBAEF3   |
...
CODE_BBAF0F:					;	   |
	...
	INY					;$BBAF2B   | |
	INY					;$BBAF2C   | |
	STA rel_level.type,x			;$BBAF2D   |/ Store level type
...
.handle_bonus_level:
	...
	SEP #$20				;$BBAF5F   | |
	STA rel_level.bonus_type,x		;$BBAF61   | | Store bonus type
	REP #$20				;$BBAF63   |/
.handle_normal_level:				;	   |
	...
	TYA					;$BBAF6E   |
	STA rel_level.entrances_address,x	;$BBAF6F   |
	STZ rel_level.destination_count,x	;$BBAF71   |
	LDA $32					;$BBAF73   |
	BRA CODE_BBAF7F				;$BBAF75  /

CODE_BBAF77:
	INC rel_level.destination_count,x	;$BBAF77  \
	TYA					;$BBAF79   |
	CLC					;$BBAF7A   |
	ADC #$0005				;$BBAF7B   |
	TAY					;$BBAF7E   |
...
CODE_BBAF8E:					;	   |
	...
	SEP #$20				;$BBAF91   |
	STA rel_level.entrance_direction,x	;$BBAF93   |
	REP #$20				;$BBAF95   |
	LDA $38					;$BBAF97   |
	AND #$00FF				;$BBAF99   |
	STA rel_level.layout_number,x		;$BBAF9C   |
	LDA $36					;$BBAF9E   |
	PHY					;$BBAFA0   |
	TAY					;$BBAFA1   |
	...
	STA rel_level.entrance_x,x		;$BBAFB8   |
	LDA.w DATA_FD0003,y			;$BBAFBA   |
	STA rel_level.entrance_y,x		;$BBAFBD   |
	BRA CODE_BBAFC3				;$BBAFBF  /

CODE_BBAFC1:
	INC rel_level.destination_count,x	;$BBAFC1  \
CODE_BBAFC3:					;	   |
	TYA					;$BBAFC3   |
	CLC					;$BBAFC4   |
	ADC #$0005				;$BBAFC5   |
...
CODE_BBB002:
	...
	PHA					;$BBB007   |
	AND #$00FF				;$BBB008   |
	STA rel_level.ppu_config_number,x	;$BBB00B   |
	PLA					;$BBB00D   |
	XBA					;$BBB00E   |
	AND #$00FF				;$BBB00F   |
	STA rel_level.vram_payload_number,x	;$BBB012   |
	RTS					;$BBB014  /
...
CODE_BBB015:
	...
	INY					;$BBB01F   |
	INY					;$BBB020   |
	STA rel_level.HDMA_init_number,x	;$BBB021   |
	LDA.w DATA_FD0000,y			;$BBB023   |
	INY					;$BBB026   |
	INY					;$BBB027   |
	STA rel_level.song,x			;$BBB028   |
...
CODE_BBB034:
	...
	INY					;$BBB037   |
	INY					;$BBB038   |
	STA rel_level.slope_init_routine,x	;$BBB039   |
	LDA.w DATA_FD0000,y			;$BBB03B   |
	INY					;$BBB03E   |
	INY					;$BBB03F   |
	STA rel_level.init_routine,x		;$BBB040   |
	RTS					;$BBB042  /
...
CODE_BBB043:
	...
	INY					;$BBB046   |
	INY					;$BBB047   |
	STA rel_level.NMI_number,x		;$BBB048   |
	LDA.w DATA_FD0000,y			;$BBB04A   |
	INY					;$BBB04D   |
	INY					;$BBB04E   |
	STA rel_level.logic_number,x		;$BBB04F   |
	RTS					;$BBB051  /
...
CODE_BBB052:
	...
	INY					;$BBB055   |
	AND #$00FF				;$BBB056   |
	STA rel_level.tileset_type,x		;$BBB059   |
	RTS					;$BBB05B  /
...
CODE_BBB066:
	...
	INY					;$BBB069   |
	INY					;$BBB06A   |
	STA rel_level.unknown_38,x		;$BBB06B   |
	LDA.w DATA_FD0000,y			;$BBB06D   |
	INY					;$BBB070   |
	AND #$00FF				;$BBB071   |
	STA rel_level.camera_control,x		;$BBB074   |
	RTS					;$BBB076  /
...
CODE_BBB077:
	...
	INY					;$BBB07A   |
	INY					;$BBB07B   |
	STA rel_level.effects,x			;$BBB07C   |
	RTS					;$BBB07E  /
...
;Dead code
	...
	INY					;$BBB08A   |
	INY					;$BBB08B   |
	STA rel_level.bonus_type,x		;$BBB08C   |
	RTS					;$BBB08E  /
...
CODE_BBB08F:
	...
	INY					;$BBB090   |
	INY					;$BBB091   |
	STA rel_level.extra_unlocks_ptr,x	;$BBB092   |
	RTS					;$BBB094  /

CODE_BBB095:
	STZ rel_level.destination_slot_1,x	;$BBB095  \
	STZ rel_level.destination_slot_2,x	;$BBB097   |
	STZ rel_level.destination_slot_3,x	;$BBB099   |
	STZ rel_level.destination_slot_4,x	;$BBB09B   |
	STZ rel_level.destination_slot_5,x	;$BBB09D   |
	STZ rel_level.destination_slot_6,x	;$BBB09F   |
	STZ rel_level.destination_slot_7,x	;$BBB0A1   |
	STZ rel_level.destination_slot_8,x	;$BBB0A3   |
	PHX					;$BBB0A5   |
...
CODE_BBB0A8:
	INY					;$BBB0A8  \
	INY					;$BBB0A9   |
	STA rel_level.destinations,x		;$BBB0AA   |
	INX					;$BBB0AC   |
	INX					;$BBB0AD   |
CODE_BBB0AE:					;	   |
...
CODE_BBB0B9:					;	   |
	...
	INX					;$BBB0CA   |
	INX					;$BBB0CB   |
	LDA main_level.layout_number		;$BBB0CC   |
	ASL A					;$BBB0CF   |
	STA $32					;$BBB0D0   |
	ASL A					;$BBB0D2   |
	ASL A					;$BBB0D3   |
...
CODE_BBB0FB:
	LDA main_level.layout_number		;$BBB0FB  \
	LDX #$0000				;$BBB0FE   |
	LDY #$007F				;$BBB101   |
CODE_BBB104:					;	   |
	PHA					;$BBB104   |
...
CODE_BBB77F:					;	   |
	...
	LDA current_palette_buffer_slot		;$BBB788   |
	DEC A					;$BBB78A   |
	AND #$000F				;$BBB78B   |
	STA current_palette_buffer_slot		;$BBB78E   |
CODE_BBB790:					;	   |
	LDA $3A					;$BBB790   |
	PHA					;$BBB792   |
	PLB					;$BBB793   |
...
if !version == 1				;	   |
	...
	STA temp_level_number			;$BBBDEE   |
	STA level_number			;$BBBDF1   |
	STZ collected_kong_letters		;$BBBDF3   |
	STZ level_entrance_number		;$BBBDF6   |
...
CODE_BBBE01:
	...
	STA level_destination_number		;$BBBE21   |/ Making all exits send the player to the map screen
CODE_BBBE24:					;	   |
...
CODE_BBBE54:
	LDA #$8000				;$BBBE54  \
	TSB exiting_sub_level_flag		;$BBBE57   |
	STZ level_entrance_number		;$BBBE5A   |
	STZ animal_type				;$BBBE5D   |
	STZ current_player_mount		;$BBBE5F   |
	STZ collected_kong_letters		;$BBBE61   |
	LDA parent_level_number			;$BBBE64   |
	STA temp_level_number			;$BBBE67   |
...
CODE_BBBEF8:
	...
	LDA level_destination_number		;$BBBEFB   |
	ASL A					;$BBBEFE   |
	TAX					;$BBBEFF   |
	LDA main_level.destinations,x		;$BBBF00   |
	AND #$01FF				;$BBBF03   |
	STA temp_level_number			;$BBBF06   |
	LDA destination_level_entrance_number	;$BBBF09   |
	XBA					;$BBBF0C   |
	ORA temp_level_number			;$BBBF0D   |
	LDX #alt_level				;$BBBF10   |
	JSL CODE_BBAF0F				;$BBBF13   |
	LDA alt_level.type			;$BBBF17   |
	AND #$0007				;$BBBF1A   |
	ASL A					;$BBBF1D   |
	TAX					;$BBBF1E   |
...
CODE_BBBF30:
	STZ collected_kong_letters		;$BBBF30  \
	STZ level_entrance_number		;$BBBF33   |
	STZ animal_type				;$BBBF36   |
	STZ current_player_mount		;$BBBF38   |
	STZ checkpoint_level_entrance_number	;$BBBF3A   |
	STZ checkpoint_level_number		;$BBBF3D   |
	STZ checkpoint_animal_type		;$BBBF40   |
	STZ checkpoint_collected_kong_letters	;$BBBF43   |
	LDA parent_level_number			;$BBBF46   |
	CMP temp_level_number			;$BBBF49   |
	BEQ CODE_BBBF65				;$BBBF4C   |
	LDA active_kong_number			;$BBBF4E   |
	CLC					;$BBBF51   |
	ADC #$0002				;$BBBF52   |
	STA $0006CF				;$BBBF55   |
	LDY parent_level_number			;$BBBF59   |
	LDA temp_level_number			;$BBBF5C   |
	JSR CODE_BBC0DD				;$BBBF5F   |
	JSR CODE_BBC07E				;$BBBF62   |
CODE_BBBF65:					;	   |
	LDA temp_level_number			;$BBBF65   |
	STA level_number			;$BBBF68   |
	STA parent_level_number			;$BBBF6A   |
	STZ level_entrance_number		;$BBBF6D   |
	LDA #$8000				;$BBBF70   |
	TRB exiting_sub_level_flag		;$BBBF73   |
...
CODE_BBBF81:
	...
	STA returning_level_number		;$BBBF86   |
	LDA destination_level_entrance_number	;$BBBF89   |
	STA returning_entrance_number		;$BBBF8C   |
	LDA temp_level_number			;$BBBF8F   |
	STA level_number			;$BBBF92   |
	STZ level_entrance_number		;$BBBF94   |
	LDA alt_level.type			;$BBBF97   |
...
CODE_BBBFC8:
	...
	STZ level_entrance_number		;$BBBFCD   |
	LDA #$8000				;$BBBFD0   |
...
CODE_BBBFE3:					;	   |
	LDA #$8000				;$BBBFE3   |
	TSB exiting_sub_level_flag		;$BBBFE6   |
	LDA returning_level_number		;$BBBFE9   |
	STA temp_level_number			;$BBBFEC   |
	LDA returning_entrance_number		;$BBBFEF   |
	STA level_entrance_number		;$BBBFF2   |
	LDA temp_level_number			;$BBBFF5   |
...
CODE_BBBFE6:					;	   |
	LDA #$8000				;$BBC019   |
	TSB exiting_sub_level_flag		;$BBC01C   |
	LDA returning_level_number		;$BBC01F   |
	STA temp_level_number			;$BBC023   |
	LDA returning_entrance_number		;$BBC026   |
	STA level_entrance_number		;$BBC029   |
	LDA temp_level_number			;$BBC02C   |
...
CODE_BBC019:
	...
	LDA.l $0006D9				;$BBC032   |
	STA main_level.type			;$BBC036   |
	LDA.l $0006DB				;$BBC039   |
	STA temp_level_number			;$BBC03D   |
	STZ level_entrance_number		;$BBC040   |
	LDA #$8000				;$BBC043   |
	TRB exiting_sub_level_flag		;$BBC046   |
...
CODE_BBC07E:
	LDA main_level.extra_unlocks_ptr	;$BBC07E  \
	STA $26					;$BBC081   |
...
CODE_BBC140:
	...
	LDA kong_cutscene_command_timer		;$BBC147   |
	BEQ CODE_BBC174				;$BBC14A   |
	DEC kong_cutscene_command_timer		;$BBC14C   |
CODE_BBC14F:					;	   |
	RTL					;$BBC14F  /

CODE_BBC150:
	INC kong_cutscene_script_index		;$BBC150  \
	INC kong_cutscene_script_index		;$BBC153   |
	INC kong_cutscene_script_index		;$BBC156   |
	INC kong_cutscene_script_index		;$BBC159   |
	RTL					;$BBC15C  /

CODE_BBC15D:
	INC kong_cutscene_script_index		;$BBC15D  \
	INC kong_cutscene_script_index		;$BBC160   |
	INC kong_cutscene_script_index		;$BBC163   |
...
.CODE_BBC34A
	LDA world_map_events			;$BBC34A  \
	ORA #$0003				;$BBC34D   |
	STA world_map_events			;$BBC350   |
...
.player_2_save:					;	   |
	...
	LDY #$0004				;$BBC654   |
	STA [$D9],y				;$BBC657   |
	LDA token_count				;$BBC659   |
	LDY #$0005				;$BBC65C   |
	STA [$D9],y				;$BBC65F   |
	LDA dk_coin_count			;$BBC661   |
	LDY #$0006				;$BBC664   |
	STA [$D9],y				;$BBC667   |
	LDA competitor_dk_coin_count		;$BBC669   |
	LDY #$0007				;$BBC66C   |
	STA [$D9],y				;$BBC66F   |
	LDA level_number			;$BBC671   |
	LDY #$0008				;$BBC673   |
	STA [$D9],y				;$BBC676   |
	LDA active_kong_number			;$BBC678   |
	LDY #$00B3				;$BBC67B   |
	STA [$D9],y				;$BBC67E   |
	LDY #$00E3				;$BBC680   |
	LDX #$002F				;$BBC683   |
-						;	   |
	LDA completed_npc_dialogue,x		;$BBC686   |
	STA [$D9],y				;$BBC689   |
	DEY					;$BBC68B   |
	DEX					;$BBC68C   |
	BPL -					;$BBC68D   |
	...
	LDY #$00B1				;$BBC6A7   |
	STA [$D9],y				;$BBC6AA   |
	LDA cheat_enable_flags			;$BBC6AC   |
	LDY #$00E4				;$BBC6AF   |
	STA [$D9],y				;$BBC6B2   |
	LDA game_state_flags			;$BBC6B4   |
	ORA #$0200				;$BBC6B7   |
	STA game_state_flags			;$BBC6BA   |
	LDY #$0009				;$BBC6BD   |
	STA [$D9],y				;$BBC6C0   |
	LDA game_state_flags_2			;$BBC6C2   |
	LDY #$000B				;$BBC6C5   |
	STA [$D9],y				;$BBC6C8   |
	LDY #$002B				;$BBC6CA   |
	LDX #$001E				;$BBC6CD   |
...
CODE_BBC776:
	...
	LDY #$0005				;$BBC795   |
	LDA [$D9],y				;$BBC798   |
	STA token_count				;$BBC79A   |
	LDY #$0006				;$BBC79D   |
	LDA [$D9],y				;$BBC7A0   |
	STA dk_coin_count			;$BBC7A2   |
	LDY #$0007				;$BBC7A5   |
	LDA [$D9],y				;$BBC7A8   |
	STA competitor_dk_coin_count		;$BBC7AA   |
	LDY #$0008				;$BBC7AD   |
	LDA [$D9],y				;$BBC7B0   |
	STA level_number			;$BBC7B2   |
	LDY #$00B3				;$BBC7B4   |
	LDA [$D9],y				;$BBC7B7   |
	STA active_kong_number			;$BBC7B9   |
	LDY #$00E3				;$BBC7BC   |
	LDX #$002F				;$BBC7BF   |
-						;	   |
	LDA [$D9],y				;$BBC7C2   |
	STA completed_npc_dialogue,x		;$BBC7C4   |
	DEY					;$BBC7C7   |
	DEX					;$BBC7C8   |
	BPL -					;$BBC7C9   |
	REP #$20				;$BBC7CB   |
