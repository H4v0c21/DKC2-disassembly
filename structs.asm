...
struct level $0000
	...
	.additional_unlock_level_temp:	skip 2	;$052F/$056D $1A,x config unlocks additional map unlock temp id (level id to unlock)
	...
	.additional_unlocks_address:	skip 2	;$0551/$058F $3C,x config unlocks additional map unlocks data address (offset in level config varies)
endstruct
