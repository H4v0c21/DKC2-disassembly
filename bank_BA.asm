bank_BA_sprite_main_handler_1:
	TAX					;$BA9000  \
	PHK					;$BA9001   |
	PLB					;$BA9002   |
	JMP (.main_table,x)			;$BA9003  /
...
set_king_zing_pattern_bank:
	%pea_mask_dbr(king_zing_pattern_table)	;$BA9042  \
	PLB					;$BA9045   |
	PLB					;$BA9046   |
	RTS					;$BA9047  /
...
king_zing_sprite_code:
	...
	JSL CODE_B4AEAF				;$BA9051   | Clear block of boss RAM for King Zing
	STZ $0765				;$BA9055   |
	STZ $32,x				;$BA9058   |
	STZ $06A1				;$BA905A   |
	STZ $06A3				;$BA905D   |
	STZ $06A5				;$BA9060   |
	LDA #king_zing_boss_commands_table	;$BA9063   |
	STA $00065A				;$BA9066   |
	LDA #$0009				;$BA906A   |
	STA $000652				;$BA906D   |
	LDA #$0002				;$BA9071   |
	...
	LDA #$000A				;$BA908E   |
	STA $000755				;$BA9091   |
	LDA #king_zing_stinger_palette_table	;$BA9095   |
	STA $000757				;$BA9098   |
	JSR parse_boss_command_BA		;$BA909C   |
CODE_BA909F:					;	   |
	LDA.l $000652				;$BA909F   |
...
CODE_BA90A8:
	INC zinger_loop_sound_enabler		;$BA90A8  \
	LDA.l $000709				;$BA90AB   |
...
CODE_BA923C:
	LDA $44,x				;$BA923C  \
	JSL execute_boss_return_command		;$BA923E   |
	LDX current_sprite			;$BA9242   |
	LDA $44,x				;$BA9244   |
	BNE CODE_BA924B				;$BA9246   |
	JSR parse_boss_command_BA		;$BA9248   |
CODE_BA924B:					;	   |
...
CODE_BA926C:					;	   |
	...
	PLB					;$BA9270   |
	JML [sprite_return_address]		;$BA9271  /
...
CODE_BA9274:
	...
	LDA #$0008				;$BA9297   |
	STA $000650				;$BA929A   |
	JSR set_king_zing_pattern_bank		;$BA929E   |
	LDA.l $000652				;$BA92A1   |
	ASL A					;$BA92A5   |
	TAY					;$BA92A6   |
	LDA king_zing_pattern_table,y		;$BA92A7   |
	TAY					;$BA92AA   |
	LDA $000A,y				;$BA92AB   |
CODE_BA92AE:					;	   |
	PHA					;$BA92AE   |
...
CODE_BA92F6:
	...
	STA $0006ED				;$BA92F9   |
	STA $000715				;$BA92FD   |
	LDA #king_zing_damage_palette_table	;$BA9301   |
	STA $0006EB				;$BA9304   |
	STA $000713				;$BA9308   |
	LDA #king_zing_stinger_palette_table	;$BA930C   |
	STA $000711				;$BA930F   |
	RTS					;$BA9313  /


king_zing_damage_palette_table:
	dw zinger_yellow_sprite_palette
	dw zinger_red_sprite_palette


king_zing_stinger_palette_table:
...
CODE_BA9334:
	...
	STZ $44,x				;$BA9351   |
	LDA #king_zing_boss_commands_table	;$BA9353   |
	STA $46,x				;$BA9356   |
	JSR parse_boss_command_BA		;$BA9358   |
...
CODE_BA943A:
	JSL turn_sprite_B6_2_global		;$BA943A  \
	LDX $0656				;$BA943E   |
	JSL turn_sprite_B6_2_global		;$BA9441   |
	LDX $0654				;$BA9445   |
	LDA $2E,x				;$BA9448   |
	AND #$FF7F				;$BA944A   |
	STA $2E,x				;$BA944D   |
...
CODE_BA9540:
	...
	STA $000650				;$BA954D   |
	PHX					;$BA9551   |
	LDY.w #DATA_FF1EC8			;$BA9552   | king zing smoke effect
	...
	STA $000650				;$BA958B   |
	PHX					;$BA958F   |
	LDY.w #DATA_FF1EC8			;$BA9590   | king zing smoke effect
...
CODE_BA95C3:					;	   |
	...
	LDA #big_king_zing_damage_pos_offsets	;$BA95E0   |
	STA $20,x				;$BA95E3   |
	LDA #CODE_B6CEA7			;$BA95E5   |
	STA $22,x				;$BA95E8   |
	LDA #$0001				;$BA95EA   |
	STA $24,x				;$BA95ED   |
	STA $26,x				;$BA95EF   |
...
CODE_BA967E:
	...
	ORA #$0400				;$BA9680   |
	STA $2E,x				;$BA9683   |
	LDA #small_king_zing_damage_pos_offsets	;$BA9685   |
	STA $20,x				;$BA9688   |
...
CODE_BA9697:
	...
	INY					;$BA96B2   |
	STY $20,x				;$BA96B3   |
	JSL move_child_to_controller_spr_global	;$BA96B5   |
CODE_BA96B9:					;	   |
	RTS					;$BA96B9  /
...
small_king_zing_damage_pos_offsets:
	dw $0003, $0003
	dw $0003, $FFFD
	dw $FFFD, $FFFD
	dw $0003, $0003
...
king_zing_ring_zinger_sprite_code:
	LDA.l $000652				;$BA9796  \ Get King Zing hit points
	BEQ .delete_ring_zinger_sprite		;$BA979A   | If King Zing dead, delete self
	LDY current_sprite			;$BA979C   | Else handle states
	LDA $0054,y				;$BA979E   |
	STA current_sprite_constants		;$BA97A1   |
	LDA $002E,y				;$BA97A3   |
	AND #$00FF				;$BA97A6   |
	ASL A					;$BA97A9   |
	TAX					;$BA97AA   |
	JMP (.state_table,x)			;$BA97AB  /

.delete_ring_zinger_sprite:
...
.return:					;	   |
	JML [sprite_return_address]		;$BA97F0  /
...
..CODE_BA9865:					;	   |
	...
	STA $52,x				;$BA9873   |
	INC $2E,x				;$BA9875   |
	JML [sprite_return_address]		;$BA9877  /

..CODE_BA987A:
	JSR .CODE_BA9884			;$BA987A  \
	JSL process_sprite_animation		;$BA987D   |
	JML [sprite_return_address]		;$BA9881  /
...
.state_3:
	...
	STA $4C,x				;$BA98BF   |
..return:					;	   |
	JML [sprite_return_address]		;$BA98C1  /

.state_4:
	TYX					;$BA98C4  \
	LDA.l $0006A5				;$BA98C5   |
	BIT #$1000				;$BA98C9   |
	BNE ..return_delete_self		;$BA98CC   |
	DEC $4C,x				;$BA98CE   |
	BNE ..return				;$BA98D0   |
	STZ $2E,x				;$BA98D2   |
	INC $1E,x				;$BA98D4   |
...
king_zing_smoke_effect_sprite_code:
	...
	BRA .return_skip_animation		;$BA994C  /
...
.CODE_BA994E:
	...
	BRL .return_skip_animation		;$BA9959  /

.CODE_BA995C:
	LDA $42,x				;$BA995C  \
	BEQ .CODE_BA9979			;$BA995E   |
	DEC $42,x				;$BA9960   |
	BNE .return_skip_animation		;$BA9962   |
.CODE_BA9964:					;	   |
	STZ $1C,x				;$BA9964   |
	LDY $0654				;$BA9966   |
	LDA $0006,y				;$BA9969   |
...
.return_skip_animation:				;	   |
	JML [sprite_return_address]		;$BA99A6  /
...
CODE_BA9A71:					;	   |
	...
	INY					;$BA9A83   |
	INY					;$BA9A84   |
	CPY #CODE_BA9324			;$BA9A85   |
	BNE CODE_BA9A8D				;$BA9A88   |
	LDY #king_zing_stinger_palette_table	;$BA9A8A   |
CODE_BA9A8D:					;	   |
	STY $0757				;$BA9A8D   |
...
CODE_BA9A96:					;	   |
	...
	PLB					;$BA9A9A   |
	JML [sprite_return_address]		;$BA9A9B  / Done processing sprite

king_zing_spikes_sprite_code:
	LDX current_sprite			;$BA9A9E  \ Get spike sprite
	LDA $42,x				;$BA9AA0   | Get X velocity interpolation preset
	JSL interpolate_x_velocity_global	;$BA9AA2   |
	LDX current_sprite			;$BA9AA6   | Get spike sprite
	LDA $44,x				;$BA9AA8   | Get Y velocity interpolation preset
	JSL interpolate_y_velocity_global	;$BA9AAA   |
	LDX $0654				;$BA9AAE   | Get King Zing sprite
	LDA $2E,x				;$BA9AB1   |
	BIT #$2000				;$BA9AB3   |
...
.CODE_BA9ADC:
	LDA $20,x				;$BA9ADC  \
	ORA $24,x				;$BA9ADE   |
	BEQ .delete_spike_sprite		;$BA9AE0   |
...
.CODE_BA9B09:
	DEC $0A,x				;$BA9B09  \
.return:					;	   |
	JML [sprite_return_address]		;$BA9B0B  /

parse_boss_command_BA:
	JSR .parse_command			;$BA9B0E  \> Parse the next boss command
	LDA $44,x				;$BA9B11   |\
	BEQ parse_boss_command_BA		;$BA9B13   |/ If no return command code is present then process next command
	RTS					;$BA9B15  /> Return

.parse_command:
	PHB					;$BA9B16  \> Preserve current bank
	LDA #$B600				;$BA9B17   |\
	PHA					;$BA9B1A   | |
	PLB					;$BA9B1B   | | Set bank of boss commands
	PLB					;$BA9B1C   |/
	LDY $46,x				;$BA9B1D   |\ Get attack pattern index
	LDA $0000,y				;$BA9B1F   |/ Get boss command
	ASL A					;$BA9B22   |\
	ASL A					;$BA9B23   |/
	PHY					;$BA9B24   |> Preserve pattern index
	TAY					;$BA9B25   |\
	LDA.w boss_commands_table,y		;$BA9B26   | | Get command code pointer
	STA $46,x				;$BA9B29   |/ Write pointer to sprite variable
	LDA.w boss_commands_return_table,y	;$BA9B2B   |\ Get command return code pointer
	STA $44,x				;$BA9B2E   |/ Write pointer to sprite variable
	PLY					;$BA9B30   |> Retrieve pattern index
	INY					;$BA9B31   |\
	INY					;$BA9B32   |/ Increment pattern index for next command or operand
	JSL execute_boss_command		;$BA9B33   |> Execute command
	PLB					;$BA9B37   | Retrieve preserved bank
	LDX current_sprite			;$BA9B38   |\ Get current sprite
	STY $46,x				;$BA9B3A   |/ Restore pattern index to sprite variable
	RTS					;$BA9B3C  /> Return
...
kreepy_krows_body_sprite_code:
	...
	LDA $42,x				;$BA9B44   | Check if the head sprite exists
	BNE .head_exists			;$BA9B46   |
	JSL CODE_B4AEAF				;$BA9B48   | Clear block of boss RAM for Kreepy Krow
	STZ $04,x				;$BA9B4C   |
	STZ $32,x				;$BA9B4E   |
	STZ $06A1				;$BA9B50   |
	STZ $06A3				;$BA9B53   |
	...
	STA $000656				;$BA9B86   | Store index of head sprite
	STA $42,x				;$BA9B8A   | And do it again but in a sprite variable
	STZ $44,x				;$BA9B8C   |
	JSR parse_boss_command_BA		;$BA9B8E   |
.head_exists:					;	   |
	LDA.l $000652				;$BA9B91   | Get Kreepy Krow hit points
	BNE .kreepy_krow_alive			;$BA9B95   |
	BRL handle_kreepy_krow_defeated_state	;$BA9B97  /
...
.CODE_BA9BF1:					;	   |
	LDA $44,x				;$BA9BF1   |
	JSL execute_boss_return_command		;$BA9BF3   |
	LDX current_sprite			;$BA9BF7   |
	LDA $44,x				;$BA9BF9   |
	BNE .CODE_BA9C00			;$BA9BFB   |
	JSR parse_boss_command_BA		;$BA9BFD   |
.CODE_BA9C00:					;	   |
	JSR CODE_BA9D02				;$BA9C00   |
	JSR CODE_BA9E91				;$BA9C03   | Checks hardcoded kong Y positions
CODE_BA9C06:					;	   |
	JSL process_sprite_animation		;$BA9C06   |
	PLB					;$BA9C0A   |
	JML [sprite_return_address]		;$BA9C0B  /
...
.return:					;	   |
	JML [sprite_return_address]		;$BA9C61  /
...
CODE_BA9CB5:					;	   |
	...
	LDA #big_king_zing_damage_pos_offsets	;$BA9CD3   |
	STA $20,x				;$BA9CD6   |
	LDA #CODE_B6CEA7			;$BA9CD8   |
	STA $22,x				;$BA9CDB   |
	LDA #$0001				;$BA9CDD   |
	STA $24,x				;$BA9CE0   |
	STA $26,x				;$BA9CE2   |
...
CODE_BA9D64:					;	   |
	...
	LDY.w #DATA_FF1E58			;$BA9D87   | kreepy krow barrel spawn smoke
...
CODE_BA9DAE:
	...
	ASL A					;$BA9DB4   |
	CLC					;$BA9DB5   |
	ADC #mini_necky_vars_setup_table	;$BA9DB6   |
	TAX					;$BA9DB9   |
	LDA $0002,y				;$BA9DBA   |
	STA $0006F5				;$BA9DBD   |
	INY					;$BA9DC1   |
	...
	LDY.w #DATA_FF1E32			;$BA9DD1   | mini necky
	BRA CODE_BA9DD9				;$BA9DD4  /

CODE_BA9DD6:
	LDY.w #DATA_FF1E0C			;$BA9DD6  \ mini necky
CODE_BA9DD9:					;	   |
...
handle_kreepy_krow_defeated_state:
	LDA.l $00065C				;$BA9FA0  \
	ASL A					;$BA9FA4   |
	TXY					;$BA9FA5   |
	TAX					;$BA9FA6   |
	JMP (.state_table,x)			;$BA9FA7  /
...
.state_1:					;	   |
	...
	CMP #$0001				;$BAA07D   |
	BNE .state_2_CODE_BAA0B2		;$BAA080   |
	LDA #$0078				;$BAA082   |
	STA $00065A				;$BAA085   |
...
kreepy_krow_death_palette_table:
...
kreepy_krows_head_sprite_code:
	LDA $000652				;$BAA1C6  \ Get Kreepy Krow hit points
	BNE .kreepy_krow_alive			;$BAA1CA   |
	BRL .return				;$BAA1CC  /
...
.main_table:
	...
	dw kore_sparkle_sprite_code		;0E krocodile_kore_sparkle_main
...
CODE_BAB0BE:
	...
	JSL CODE_B4C175				;$BAB0E8   | Get RNG
	LDY #$0020				;$BAB0EC   |
...
sparkle_spawner_sprite_code:
	...
	JSL CODE_B4C175				;$BAB14D   | Get RNG
	LDY #$001E				;$BAB151   |
...
sparkle_sprite_code:
	...
	JML [sprite_return_address]		;$BAB1B6  /
...
bonus_screen_config_table:
	dw .destroy_them_all
	dw .collect_the_stars
	dw .find_the_token
...
CODE_BAB50D:
	TAX					;$BAB50D  \
	%pea_mask_dbr(yellow_font_tile_offsets)	;$BAB50E   |
	PLB					;$BAB511   |
	PLB					;$BAB512   |
	LDA.w yellow_font_tile_offsets,x	;$BAB513   |
	PHK					;$BAB516   |
	PLB					;$BAB517   |
	AND #$00FF				;$BAB518   |
	XBA					;$BAB51B   |
...
CODE_BAB580:
	...
	PHB					;$BAB58A   |
	%pea_mask_dbr(yellow_font_tile_offsets)	;$BAB58B   |
	PLB					;$BAB58E   |
	PLB					;$BAB58F   |
...
CODE_BAB5B5:					;	   |
	...
	STA $00065C				;$BAB5C0   |
	LDX $065C				;$BAB5C4   |
	LDA.w yellow_font_tile_offsets,x	;$BAB5C7   |
	ASL A					;$BAB5CA   |
	REP #$20				;$BAB5CB   |
CODE_BAB5CD:					;	   |
	STA [$C8],y				;$BAB5CD   |
...
CODE_BAB60F:
	PHB					;$BAB60F  \
	%pea_mask_dbr(yellow_font_tile_offsets)	;$BAB610   |
	PLB					;$BAB613   |
	PLB					;$BAB614   |
...
init_credits_screen:
	...
	JSL reset_camera_and_bg_scroll		;$BAB65D   |
	LDA #$0780				;$BAB661   |
	STA $000650				;$BAB664   |
	LDA #$3EFF				;$BAB668   |
	LDX #$7000				;$BAB66B   |
...
krool_water_drips_sprite_code:
	...
	JML [sprite_return_address]		;$BAC0DF  /
...
.dummy_animated_state:
	...
	JML [sprite_return_address]		;$BAC0F7  / done processing sprite
...
.state_1:
	...
	JML [sprite_return_address]		;$BAC110  /
...
.return:					;	   |
	JML [sprite_return_address]		;$BAC130  / done processing sprite
...
.return:					;	   |
	...
	PLB					;$BAC252   |
	JML [sprite_return_address]		;$BAC253  /
...
.CODE_BAC318:					;	   |
	...
	STA $2A,x				;$BAC326   |
.CODE_BAC328:					;	   |
	LDA $44,x				;$BAC328   | Get velocity interpolation preset
	PHA					;$BAC32A   |
...
.handle_state:
	...
	ASL A					;$BAC34B   |
	TAX					;$BAC34C   |
	JMP (.state_table,x)			;$BAC34D  /

.state_table:
	dw .wait_for_collision
	dw .display_text
	dw .idle
...
..collision_happened:
	SEP #$20				;$BAC36A  \ 8-Bit A
	LDA #$17				;$BAC36C   |
	STA PPU.screens				;$BAC36E   | Enable bg3
	REP #$20				;$BAC371   | 16-Bit A
	LDX current_sprite			;$BAC373   | Get scroll sprite
...
.display_text:
	LDX current_sprite			;$BAC386  \ Get scroll sprite
	DEC $4E,x				;$BAC388   | Decrease timer for hiding text
	BPL .idle				;$BAC38A   | If not done yet, return
	SEP #$20				;$BAC38C   | Else set 8-Bit A...
	LDA #$13				;$BAC38E   |
