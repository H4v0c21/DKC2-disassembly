...
if !exhi == 1					;	   |
	LDY #$0000				;$B3C301   |\ Y = address to checksum (address so far: $??8080)
else						;	   | |
...
CODE_B3D5AD:
	...
	STA $4E,x				;$B3D5C1   |
	LDA $34,x				;$B3D5C3   |
	CMP active_kong_sprite			;$B3D5C5   |
	BEQ CODE_B3D5CF				;$B3D5C8   |
	CMP inactive_kong_sprite		;$B3D5CA   |
...
CODE_B3DF5F:
	...
	STZ $16,x				;$B3DF65   |
if !exhi == 1					;	   |
	PER RESET_start+$800000+$330000		;$B3DF67   |\ Piracy check
else						;	   | |
