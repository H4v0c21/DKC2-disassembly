...
unknown_sprite_0090_main:
	LDA $05BB				;$B3819B  \ \
	AND #$0060				;$B3819E   | |
	BEQ CODE_B381AA				;$B381A1   |/ If no debug flags are set
...
sprite_fg_occluder_main:
	...
	LDY active_kong_sprite			;$B388D3   |
	JSR CODE_B388EA				;$B388D6   |
	LDY inactive_kong_sprite		;$B388D9   |
...
CODE_B39314:
	...
	CMP #!level_king_zing_sting		;$B39316   |
...
CODE_B39336:
	...
	CMP #!level_king_zing_sting		;$B39338   |
...
no_animal_buddy_sign_main:
	...
	LDA #$0040				;$B3A046   |
	TSB $052B				;$B3A049   | Else set some level effect flag
.dont_set_flag:					;	   |
if !version == 1				;	   |
	...
	BNE .sprite_found			;$B3A054   | If it exists, player is riding one or is transformed
...
CODE_B3A2EB:					;	   |
	...
	LDA #$002A				;$B3A2F2   |
	JSL set_player_interaction_global	;$B3A2F5   |
...
make_sprite_fall_off_screen:
	...
	JSL CODE_BB82B8				;$B3A667   |> Else despawn sprite
.done_processing				;	   |
	JML [$05A9]				;$B3A66B  /
...
.handle_splashing
	...
	LDA $06,x				;$B3A684   |
	STA $0A3E				;$B3A686   |
	JSL CODE_BB82B8				;$B3A689   | Despawn sprite
...
CODE_B3BE6C:					;	   |
	...
	JSL process_current_movement		;$B3BE71   |
...
.delete_icon_sprite:
	JSL CODE_BB82B8				;$B3E6AC  \ delete sprite
