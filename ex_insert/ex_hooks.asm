...
if !game_version == 0
	...
	apply_sprite_gravity = $B39EA8
	defeat_sprite_using_anim = $B3A5FF
	initialize_platform_sprite = $B3D446
	set_platform_hitbox_position = $B3D45F
	set_platform_hitbox_size = $B3D488
	force_sprite_submerged = $B3F662
	process_animation_handle_submerged = $B3F666
	defeat_aquatic_sprite_using_anim = $B3F66A
	make_sprite_fall_off_screen_with_default_constants = $B3F66E
	make_sprite_fall_off_screen_with_defined_constants = $B3F671
	check_for_sprite_crush = $B3F6AF
	apply_x_acceleration = $B3F6B3
	apply_y_acceleration = $B3F6B7
	get_rng_rshift_xor = $B4C12D
	queue_sound_effect = $B58003
	spawn_hit_star_relative = $B6FF39
	...
	is_current_level_kremcoin_collected = $BB8114
	is_level_kremcoin_collected = $BB8116
	set_this_level_kremcoin_collected = $BB8125
	is_current_level_dk_coin_collected = $BB8135
	is_level_dk_coin_collected = $BB8138
	set_current_level_dk_coin_collected = $BB8147
	set_current_level_as_cleared = $BB8158
	delete_sprite_handle_deallocation = $BB82B8
	deallocate_sprite_vram_slot = $BB83B4
	spawn_vanilla_sprite_from_index = $BB842C
	spawn_vanilla_sprite_from_address = $BB8432
	apply_spawn_script_to_slot = $BB8474
	request_sprite_palette_from_index = $BB8A61
	request_palette_from_address = $BB8A65
	get_spawn_position_in_level_data = $BB8BE9
	dereference_sprite_palette = $BB8C02
	...
	set_sprite_target_hud_position = $BEC5B1
	...
	apply_sprite_gravity = $B39EC8
	defeat_sprite_using_anim = $B3A623
	initialize_platform_sprite = $B3D46C
	set_platform_hitbox_position = $B3D485
	set_platform_hitbox_size = $B3D4AE
	force_sprite_submerged = $B3F6F2
	process_animation_handle_submerged = $B3F6F6
	defeat_aquatic_sprite_using_anim = $B3F6FA
	make_sprite_fall_off_screen_with_default_constants = $B3F6FE
	make_sprite_fall_off_screen_with_defined_constants = $B3F701
	check_for_sprite_crush = $B3F73F
	apply_x_acceleration = $B3F743
	apply_y_acceleration = $B3F747
	get_rng_rshift_xor = $B4C175
	queue_sound_effect = $B58003
	spawn_hit_star_relative = $B6FE9E
	...
	set_sprite_target_hud_position = $BEC5BC
